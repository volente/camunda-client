...
public abstract class DeleteAPI<S, T> extends API<S, T> {

    private static final Logger LOGGER = LoggerFactory.getLogger(DeleteAPI.class);

    public DeleteAPI(String engineId) {
        super(engineId);
    }
